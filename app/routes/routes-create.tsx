      ...
      >
        {routeData? (
          <View style={styles.routeDataContainer}>
            ...
            <ThemedText style={{color: '#fff', flexWrap: 'wrap'}}>
          ...
          <View style={{flexDirection: 'row', alignItems: 'center', gap: 7, marginBottom: 10}}>
            ...
            <ThemedText type='defaultSemiBold'>Your Location to</ThemedText>
          </View>
          ...
          <LocationAutocomplete
            ...
            style={[styles.inputField, { zIndex: 100 - index }]}
          />
        </View>))}
        <View key="end">
          <LocationAutocomplete
            ...
            style={[styles.inputField, { zIndex: 100 - waypoints.length }]}
          />
        </View>
        <ScrollView 
          horizontal 
      ...
      >
        {routeData ? (<>
          <TouchableOpacity style={styles.sideButton} onPress={() => setRouteData(null)}>
            <ThemedIcons library="MaterialIcons" name="arrow-back" size={20} color="#fff" />
          </TouchableOpacity>

          <TouchableOpacity style={styles.startButton} onPress={handleStartRoute}>
            <ThemedIcons library="MaterialIcons" name="play-arrow" size={32} color="#fff" />
          </TouchableOpacity>

          <TouchableOpacity style={styles.sideButton} onPress={handleCancelRoute}>
            <ThemedIcons library="MaterialIcons" name="close" size={20} color="#fff" />
          </TouchableOpacity>
        </>
      ):(
